package com.flikly.backend.global.constant;

public final class ErrorMessages {

    private ErrorMessages() {} // 유틸 클래스라 생성자 막음

    public static final class Email {
        public static final String EMPTY = "이메일은 빈 값일 수 없습니다.";
        public static final String INVALID_FORMAT = "유효하지 않은 이메일 형식입니다: %s";
    }
    ...
    public static final class Name {
        ...
        public static final String LENGTH = "이름은 %d자 이상 %d자 이하여야 합니다.";
    }
